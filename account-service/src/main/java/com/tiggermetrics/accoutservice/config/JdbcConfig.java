package com.tiggermetrics.accoutservice.config;
...
public class JdbcConfig {
    ...
    public ServletRegistrationBean servletRegistrationBean() {
        ...
        //访问的用户名密码
        map.put(StatViewServlet.PARAM_NAME_USERNAME, "njulight");
        map.put(StatViewServlet.PARAM_NAME_PASSWORD, "123456");
        //允许访问的ip，默认是所有ip
        map.put(StatViewServlet.PARAM_NAME_ALLOW, "192.168.0.110");
        //禁止访问的ip
        map.put(StatViewServlet.PARAM_NAME_DENY, "192.168.0.1");
